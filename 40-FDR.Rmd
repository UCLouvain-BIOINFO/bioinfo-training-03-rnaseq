...
To mimic this, we are going to simulate a strong up-regulation for the first 1,000 genes
...
Now let's look at p-values histogram of the first 1000 genes (for which Ho is FALSE), and of the remaining genes.
...
- How many genes would you expect to remain significant after FDR correction in the first dataset (`res` table) ?
