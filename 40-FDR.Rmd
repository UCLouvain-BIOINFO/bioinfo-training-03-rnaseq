...
```{r fdr-xkcd-jellybeans, eval=FALSE, fig.align='center', fig.cap="Do jelly beans cause acne? Scientists investigate. From [xkcd](https://xkcd.com/882/).", include=FALSE, purl=FALSE, results='markup'}
...
positives among all discoveries. It allows us to choose n results with
a given FDR.
