...
order. Here `Epithelial_KD` was hence set arbitrarily as the reference level of the group factor. 
...
Restart the analysis from the beginning to analyze the data in a way that addresses 
the following question:

*Which genes are affected differently by the siRNA in epithelial and fibroblast cells?*
