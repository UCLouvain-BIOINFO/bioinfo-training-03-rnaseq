...
rowMeans(counts(dds[best_gene], normalize = TRUE))
```
...
log2(rowMeans(counts(dds[best_gene, dds$group == "Epithelial_ctl"], normalize = TRUE)))
```
...
log2(rowMeans(counts(dds[best_gene, dds$group == "Epithelial_KD"], normalize = TRUE)))
```
