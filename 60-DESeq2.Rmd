...
1. Inspect counts of genes "ZBED2", "HS6ST2", "CASC18", "CKAP2LP1",
   and "LOC124905065", plotted in red in the following volcano-plot.
   (These genes have a very large log2FC). What is the most striking?
...
```{r}
selected_genes <- c("ZBED2", "GASK1B", "HS6ST2", "CASC18", "CKAP2LP1", "LOC124905065")
...
Restart the analysis from the beginning to analyze the data in a way
that addresses the previous question...
