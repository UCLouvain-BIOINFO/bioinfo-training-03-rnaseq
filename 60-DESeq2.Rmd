...
fig1 <- tibble(meanCounts = rowMeans(counts(dds_group1, normalize = TRUE)),
         Variance = rowVars(counts(dds_group1, normalize = TRUE))) |>
...
as_tibble(counts(dds[best_genes, ], normalize = TRUE), rownames = 'gene') |>
...
as_tibble(counts(dds[selected_genes, ], normalize = TRUE),
          rownames = 'gene') |>
