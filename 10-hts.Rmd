...
The main steps of an RNA-seq experiment will be described, from library 
preparation to the sequencing process.

We will explore FASTQ files and learn how to process them through a typical 
RNA-seq pipeline, including quality control, read alignment, and gene 
quantification.
...
processed_data/bam/*.bam    # All bam files
```
